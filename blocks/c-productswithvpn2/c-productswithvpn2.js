...
export default function decorate(block) {
  ...
  if (productsAsList.length) {
    ...
    productsAsList.forEach((product, idx) => {
      ...
      tableBuybtn.innerHTML = `<div class="buy_box buy_box${idx + 1}"><a href='#' title='Bitdefender ${onSelectorClass}' class='red-buy-button await-loader prodload prodload-${onSelectorClass} buylink-${onSelectorClass}'>${tableBuybtn.innerText}</a></div>`;
