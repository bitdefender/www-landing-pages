...
export default function decorate(block) {
  ...
  if (productsAsList.length) {
    ...
    productsAsList.forEach((item, idx) => {
      ...
      let pricesDiv = `<div class="prices_box awaitLoader prodLoad prodLoad-${onSelectorClass}">`;
      ...
      tableBuybtn.innerHTML = `<div class="buy_box buy_box${idx + 1}"><a href="#" title="Bitdefender" class="red-buy-button buylink-${onSelectorClass} awaitLoader prodLoad prodLoad-${onSelectorClass}">${tableBuybtn.innerText}</a></div>`;
    });
  }
}
