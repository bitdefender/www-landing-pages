...
export default function decorate(block) {
  ...
  const {
    product, products, contentSize, animatedText, backgroundColor, backgroundHide, textColor, underlinedInclinedTextColor, textAlignVertical, imageAlign, paddingTop, paddingBottom, marginTop, marginBottom, imageCover, corners,
  } = metaData;
