...
export default function decorate(block) {
          ...
          combinedPricesBox.innerHTML += `<div class="combinedPricesBox combinedPricesBox-${selectorClass}" ${idx !== 0 ? 'style="display: none;"' : ''}>
            ...
            <div class="prices_box await-loader prodload prodload-${selectorClass}">
              ...
              ${replaceBuyLinks ? `<div class="buy-btn">
                <a class="red-buy-button buylink-${selectorClass} await-loader prodload prodload-${selectorClass}" href="${buyLinkObj.href || '#'}"  title="Bitdefender">
  ...
  ${billed ? (() => {
    ...
    return `<div class="billed">${tempDiv.innerHTML}</div>`;
              ...
              ${replaceBuyLinks ? `<div class="buy-btn">
                  <a class="red-buy-button buylink-${selectorClass} await-loader prodload prodload-${onSelectorClass}" href="${buyLinkObj.href || '#'}" title="Bitdefender">${buyLinkObj.text.includes('0%') ? buyLinkObj.text.replace('0%', `<span class="percent-${onSelectorClass}"></span>`) : buyLinkObj.text}</a>
                </div>` : `<div class="buy-btn">
                <a class="red-buy-button buylink-${selectorClass} await-loader prodload prodload-${onSelectorClass}" href="#" title="Bitdefender">
                  ${buyLinkText.includes('0%') ? buyLinkText.replace('0%', `<span class="percent-${onSelectorClass}"></span>`) : buyLinkText}
                </a>
                </div>`}
