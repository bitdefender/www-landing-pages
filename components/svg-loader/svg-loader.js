  ...
  render() {
    switch (this.#svgName) {
      ...
      case 'gauge-indicator':
        ...
        return `<svg style="${this.#style}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105.14 82.6"><defs><style>.cls-1,.cls-2{fill:none;stroke-linecap:round;stroke-linejoin:round;stroke-width:3px;}.cls-1{stroke:#006eff;}.cls-2{stroke:#00439c;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1">
        <path class="cls-1" d="M76.8,34.14c0-2.76,0-5.51,0-8.27C76.74,16,72.15,8.54,63.55,4.12A23.55,23.55,0,0,0,36.27,8.25a23.76,23.76,0,0,0-7.34,14.59,75.54,75.54,0,0,0-.07,9.4v1.9"/>
        <path class="cls-1" d="M23.7,65.32V77.76c0,.3,0,.61,0,.91.13,1.8.8,2.43,2.58,2.43h53c2,0,2.71-.66,2.72-2.73,0-3.14,0-6.27,0-9.41"/>
        <path class="cls-1" d="M66.79,34.14c0-2.71,0-5.41,0-8.12A14,14,0,0,0,55,11.89a13.89,13.89,0,0,0-15.8,11.25c-.58,3.66-.14,7.33-.29,11"/>
        <path class="cls-1" d="M23.7,41.73c0-1.85,0-3.7,0-5.54,0-1.23.46-1.7,1.69-1.69,3.59,0,7.18,0,10.77,0H64.51c3.39,0,6.79.14,10.16-.05,1.94-.11,3.85.16,5.77.05C81.53,34.45,82,35,82,36c0,1.89,0,3.79,0,5.69"/>
        <path class="cls-1" d="M17.91,42.11c2.73,0,5.46,0,8.19,0a3.46,3.46,0,0,1,2.59.91c1.17,1.06,2.43,2,3.63,3a4.15,4.15,0,0,0,3.34,1.08c1.05-.1,2.12,0,3.18,0"/>
        <path class="cls-1" d="M86.08,58.09c-2.73,0-5.46,0-8.19,0A3.47,3.47,0,0,0,75.3,59c-1.17,1.06-2.43,2-3.63,3a4.24,4.24,0,0,1-3.34,1.08,30.82,30.82,0,0,0-3.19,0"/>
        <path class="cls-1" d="M93.46,58.09c-2.73,0-12.84,0-15.57,0A3.47,3.47,0,0,0,75.3,59c-1.17,1.06-2.43,2-3.63,3a4.24,4.24,0,0,1-3.34,1.08,30.82,30.82,0,0,0-3.19,0"/>
        <path class="cls-1" d="M16.45,52.93c2.73,0,12.84,0,15.57,0a3.5,3.5,0,0,1,2.59.91c1.17,1.06,2.43,2,3.63,3A4.17,4.17,0,0,0,41.58,58"/>
        <path class="cls-1" d="M65.14,63.25c2.73,0,5.47,0,8.2,0a3.48,3.48,0,0,1,2.59.91c1.17,1.06,2.43,2,3.62,3a4.18,4.18,0,0,0,3.35,1.08c1-.1,2.12,0,3.18,0"/>
        <path class="cls-1" d="M65.14,63.25c2.73,0,5.47,0,8.2,0a3.48,3.48,0,0,1,2.59.91c1.17,1.06,2.43,2,3.62,3a4.18,4.18,0,0,0,3.35,1.08c1-.1,4.12,0,5.18,0"/>
        <path class="cls-1" d="M90.36,42.11c-2.73,0-9.46,0-12.19,0a3.46,3.46,0,0,0-2.59.91c-1.17,1.06-2.43,2-3.63,3a4.17,4.17,0,0,1-3.34,1.08c-1.06-.1-2.13,0-3.19,0"/>
        <path class="cls-1" d="M34.12,64.42c-2.73,0-5.46,0-8.19,0a3.53,3.53,0,0,0-2.6.91c-1.17,1.06-2.42,2-3.62,3.06a4.2,4.2,0,0,1-3.35,1.07c-1-.1-2.12,0-3.18,0"/>
        <path class="cls-2" d="M56.47,71.24H49.19"/>
        <path class="cls-1" d="M51.92,43.32c-3.22.63-5.46,2.35-6.38,5.61-.73,2.57-.38,5,1.58,6.77a5.73,5.73,0,0,1,2,5.07A14.94,14.94,0,0,0,49.33,66h6.94a6,6,0,0,0,.35-3c0-1.36,0-2.73,0-4.09a2.37,2.37,0,0,1,.9-2.16,7.31,7.31,0,0,0,2.91-5.58,7.74,7.74,0,0,0-8.35-7.89"/>
        <path class="cls-1" d="M86.78,50.16H76.72"/>
        <path class="cls-1" d="M30.78,58.47H26.13"/><circle class="cls-2" cx="97.8" cy="42.09" r="5.84"/><circle class="cls-2" cx="96.2" cy="68.31" r="5.84"/><circle class="cls-2" cx="10.61" cy="42.09" r="5.84"/><circle class="cls-2" cx="7.34" cy="68.31" r="5.84"/></g></g></svg>`;
